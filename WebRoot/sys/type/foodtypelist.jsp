	...
	<div id="MainArea">
					...
					<c:when test="${not empty requestScope.list }">
						<c:forEach var="foodType" items="${requestScope.list }">
							<tr align="center">
								...
								<td>
									<a href="${pageContext.request.contextPath }/foodType?id=${foodType.id}&method=show" class="FunctionButton">更新</a> 
		...
		<div id="TableTail" align="center">
			<div class="FunctionButton">
				<a href="${pageContext.request.contextPath }/sys/type/foodtypesave.jsp">添加</a>
			</div>
		</div>
	</div>
</body>
